...
from mainApp.views import (
    ...
    google_login, google_callback, naver_login, naver_callback,
    PostListView, PostDetailView, CommentListView, CommentDetailView, CategoryListCreateView, IngredientListCreateView, IngredientDetailView
)
